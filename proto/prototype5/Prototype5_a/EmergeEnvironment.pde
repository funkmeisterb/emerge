...
class EmergeEnvironmentManager extends QualiaEnvironmentManager
{
  ...
  {
    QualiaOscMunchkin munchkin = new QualiaOscMunchkin(thisBooth.munchkinConfig.get(id).nation, (int)random(50,width-50), (int)random(50,height-50), random(MUNCHKIN_MIN_SIZE, MUNCHKIN_INITIAL_MAX_SIZE), MUNCHKIN_INITIAL_HEAT);
